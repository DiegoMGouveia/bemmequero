...
class UploadImagem
{
    ...
    protected function redimensionar($caminho, $nomearquivo)
    {
        ...
        // Se altura é maior que largura, dividimos a altura determinada pela original e multiplicamos a largura pelo resultado, para manter
        //a proporção da imagem
    ...
    public function salvar($caminho, $file)
    {
        ...
        $file['name'] = date("Y.m.d-H.i.s") . $ext; //Definindo um novo nome para o arquivo

        
        // Atribuímos caminho e nome da imagem a uma variável apenas
        $uploadfile = $caminho.$file['name'];

        // Guardamos na variável o tipo do formato do arquivo enviado
        ...
        } /* -> fim if */ else
        {
            ...
            $mensagem = array("<a href='".$uploadfile."'><font color='#070'>Upload realizado com sucesso!</font><a>", $uploadfile);
